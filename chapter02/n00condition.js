// if (true) console.log("사실");  // 실행문이 한 줄이면 {}를 생략 가능합니다.
// if (false) {
//   console.log("거짓");
// };
...
// true를 반환하는 코드 혹은 false 를 반환하는 코드 
// let n = 1;
// if(n > 0) { // true를 반환하는 코드 혹은 false 를 반환하는 코드 : 조건식
//   console.log("자연수 입니다.");
// }
...
// if 절 내의 조건식이 참이면 else는 실행되지 안흔
...
/*
  switch문의 () 내에는 str, number도 오는것이 가능
  ...
  그러므로 break; 가 없다면 그 다음 case 까지 실행이 된다는 점에 유의할 필요가 있음
