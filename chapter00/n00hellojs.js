...
// 길게 작성했을 경우에도 동일하게 우리는 ctrl + / 를 이용하여 주석 처리

// 변수와 상수
// let darkModeOn = true;
// const PI = 3.14159;
// index.html 파일 생성 -> 개발자 도구를 통해서 콘솔 확인이 가능
...
// 이상으 ㅣ코드에서 자바스크립트 / 파이썬에서는 데이터의 종류를 구분하는 데 있어 타 언어만큼 엄격한 기준이 있지 않음
...
//     at n00hellojs.js:30:3 -> 라고 오류 발생

// let c = 10;  -> 동일한 변수를 두 번 선언했기 때문에 
// let c = 12;
// Uncaught SyntaxError: Identifier 'c' has already been declared (at n00hellojs.js:34:5) -> 라고 오류 발생
...
// 이상으 ㅣ코드에서 알 수 있는 점은 조건식에 자주 사용되고, 비교 연산의 결과값을 산출 할 떄 많이 사용
...
copy object ->  console.log(person01) 찍었더니 key에 "" 붙어있는 걸로 보아 JSON 형태로 표기됨
{
    "name": "김철수",
    "age": 25,
    "address": "부산광역시 연제구",
...
// 객체를 통해서 지정한 value 를 상수에 저장하여 (#1, #2를 이용해서 특정 값만 산출한 후에), 걔네만 콘솔에 출력함
...
// Uncaught TypeError: Assignment to constant variable. at n00hellojs.js:194:10
